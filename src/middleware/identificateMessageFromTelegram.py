    ...
    if request.endpoint == "telegram":
        ...
        if "message" in body:
            ...
            if user is not None:
                ...
                user = insertUser(
                    chat_id=chat_id, name=from_name, status="awaiting_email"
                )
            ...
            if transaction_state == "validate_email":
                ...
                if isValidEmail(message_sent):
                    ...
                    transaction_state = (
                        "validated" if status == "completed" else "send_phone_message"
                    )
            ...
            if user["EMAIL"] is None or transaction_state == "send_email_message":
                print(
                    "Enviando mensagem de email por email: ",
                    user["EMAIL"],
                    "e o estado é: ",
                    transaction_state,
                )
                    ...
                    [
                        {
                            ...
                            "callback_data": "/cadastro/updateEmail:first_time",
                        }
                    ]
                ]
            ...
            if transaction_state == "validate_phone":
                ...
                if isValidPhone(message_sent):
                    ...
                    transaction_state = (
                        "validated"
                        if user["STATUS"] == "updating_phone"
                        else "validation_completed"
                    )
                    user = updateUser(
                        id=user["ID"], phone=message_sent, status="completed"
                    )
            ...
            if user["PHONE"] is None or transaction_state == "send_phone_message":
                print(
                    "Enviando mensagem de telefone por telefone: ",
                    user["PHONE"],
                    "e o estado é: ",
                    transaction_state,
                )
                    ...
                    [
                        {
                            ...
                            "callback_data": "/cadastro/updatePhone:first_time",
                        }
                    ]
                ]
                sendMessage(chat_id, text, buttons)
            ...
            if body["my_chat_member"]["chat"]["type"] == "channel":
                ...
                if (
                    body["my_chat_member"]["new_chat_member"]["status"] == "kicked"
                    or body["my_chat_member"]["new_chat_member"]["status"] == "left"
                ):
